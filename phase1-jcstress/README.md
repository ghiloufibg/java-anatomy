...
- `WriterPreferringLockStressTest` — hammers `dev.sevenrungs.phase1.WriterPreferringReadWriteLock`
...
```
mvn -q -pl phase1-jcstress -am package   # builds target/jcstress.jar (an executable uber-jar)
java -jar phase1-jcstress/target/jcstress.jar
```
